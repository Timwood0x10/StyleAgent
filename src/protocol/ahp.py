...
class TokenController:
    ...
    def create_compact_instruction(self, user_profile: Dict, task: Dict, 
                                  context: str = "", max_tokens: int = None) -> str:
...
class AHPSender:
    ...
    def __init__(self, message_queue: MessageQueue, token_controller: TokenController = None):
    ...
    def send_task(self, target_agent: str, task_id: str, session_id: str, 
                  payload: Dict[str, Any], token_limit: int = 500,
                  context: str = "") -> AHPMessage:
        ...
        compact_instruction = self.token_controller.create_compact_instruction(
            ...
            task={"category": payload.get("category"), "instruction": payload.get("instruction")},
            context=context,
        ...
        print(f"   SEND [->{target_agent}] TASK: {payload.get('category', 'unknown')} (token_limit: {token_limit})")
        return msg
...
class AHPReceiver:
    ...
    def send_progress(self, session_id: str, task_id: str, progress: float, message: str = ""):
    ...
    def send_result(self, session_id: str, task_id: str, result: Dict, status: str = "success"):
